...
RailsAdmin.config do |config|
  ...
  # If your default_local is different from :en, uncomment the following 2 lines
  # and set your default locale here:
  # require 'i18n'
  ...
  # config.models do
  #   # Configuration here will affect all included models in all scopes, handle
  #   # with care!
  #
  #   list do
  ...
  #       # Configuration here will affect all date fields, in the list section,
  #       # for all included models. See README for a comprehensive type list.
  #     end
  #   end
  # end
  #
  ...
  # RailsAdmin will try his best to provide the best defaults for each section,
  # for each field.
  ...
  #   # Name of the method called for pretty printing an *instance* of ModelName
